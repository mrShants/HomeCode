    ...
    public partial class FormCustomer : Form
    {
        ...
        private void btnPhone_Click(object sender, EventArgs e)
        {
            ...
            if (dgvCustomers.SelectedCells.Count > 0)
            {
                ...
                customerContact = Convert.ToString(selectedRow.Cells["Contact"].Value);
            ...
            {
                MessageBox.Show("Please select a client to Contact");
            }

            Call call = new Call();


            call.GetCustomerDetails(customerName, customerSurname, customerContact);
            call.Show();

            call.FormClosed += new FormClosedEventHandler(ChildForm_Closed);
        ...
        public void RefreshPage()
        {
            ...
            List<CallLogs> getCallData = new List<CallLogs>();

            getCallData = new CallLogs().getBLCall();

            dgvCall.DataSource = getCallData;
